    ...
    <div class="form-group">
        <div class="row">
            <div class="col-4">
                {!! Form::label('worker','Trabajadores', ['class' => '']) !!}
            </div>
            <div class="col-8"> 
                {!! Form::text('worker', null, ['class' => 'form-control', 'required' => 'true',  $status_form == 'show' ? 'disabled' : '']) !!}
                {!! $errors->first('worker', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-8">   
                {!! Form::file('file', null, ['class' => 'form-control', $status_form == 'show' ? 'disabled' : '' ]) !!}
