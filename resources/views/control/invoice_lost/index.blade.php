      ...
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
            ...
            <th class="text-sm">Vendedor</th>
            <th class="text-sm">Local</th>
            <th class="text-sm">Estatus</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="text-sm"> <a href="{{ route($route['show'], $item->id) }}">{{ $item->type . " " . $item->number }}</a></td>
            <td class="text-sm">{{ $item->client }}</td> 
            <td class="text-sm">{{ $item->seller }}</td> 
            <td class="text-sm">{{ $item->local }}</td> 
