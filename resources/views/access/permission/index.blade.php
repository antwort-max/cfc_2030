...
@section('content_header')
    <div class="row">
        <div class="col-md-6"><h5>Permisos</h5></div>
        <div class="col-md-6 text-right">
            <a href="{{ route('access.permission.create') }}" class="btn btn-sm btn-primary"> + Nuevo </a>
        </div>
    </div>
@stop
            ...
            <table id="example" class="table table-striped dt-responsive nowrap table-hover" style="width:100%">
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            <td><a href="{{ route('access.permission.edit', $item->id) }}"> {{ $item->name }}</a></td>
