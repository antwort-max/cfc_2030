      ...
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
			...
			<th class="text-sm">Dias pendientes</th>
            <th class="text-sm">Inicio Vacaciones</th>
            <th class="text-sm">Final Vacaciones</th>
 			<th class="text-sm">Dias de Vacaciones</th>
            <th class="text-sm">Quedan</th>
        ...
        <tbody>
          ...
          <tr>
			...
			<td class="text-sm">{{ $item->period_a + $item->period_b }}</td> 
            <td class="text-sm">{{ $item->start }}</td> 
            <td class="text-sm">{{ $item->end }}</td> 
			<td class="text-sm">{{ $item->progresive_days + $item->bussiness_days + $item->holidays_days + $item->fraccion_days }}</td> 
            <td class="text-sm">{{ $item->slope_working + $item->slope_holiday + $item->slope_progresive }}</td> 
