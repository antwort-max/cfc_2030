      ...
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
            ...
            <th class="text-sm">Rut</th>
            <th class="text-sm">Telefono</th>
            <th class="text-sm">Numero documento</th>
            <th class="text-sm">Concurso</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-sm">{{ $item->dni }}</td>
            <td class="text-sm">{{ $item->phone }}</td> 
            <td class="text-sm">{{ $item->document }}</td>
            <td class="text-sm">{{ $item->contest}}</td>  
