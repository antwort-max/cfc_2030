    ...
    <div class="card-body">
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
            <th class="text-sm">#</th>
            <th class="text-sm">Nombre Cliente</th>
            <th class="text-sm">Correo Cliente</th>
            <th class="text-sm">Marca</th>
            <th class="text-sm">Producto</th>
            <th class="text-sm">Formula</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-sm"> <a href="{{ route($route['show'], $item->id) }}">{{ $item->client_name }}</a></td>
            <td class="text-sm">{{ $item->client_mail}}</td> 
            <td class="text-sm">{{ $item->brand }}</td>
            <td class="text-sm">{{ $item->product }}</td> 
            <td class="text-sm">{{ $item->formula }}</td> 
