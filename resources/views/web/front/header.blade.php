<div class="container-fluid">
        <div class="row mt-3">
            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                <img class="img-fluid" src="{{ asset('img/logo-caupolican.jpg') }}" alt="">
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 text-center mt-2">
                {!! Form::open(['route' => 'web.search', 'method' => 'POST', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="card">
                    <table>
                        <tr>
                            ...
                            <td class="text-center text-primary"><i class="bi bi-person-fill"></i></td>
