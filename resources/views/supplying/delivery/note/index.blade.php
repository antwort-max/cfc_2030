  ...
  <div class="card">
    <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-2 text-right"><a href="{{ route($route['create']) }}" class="btn btn-sm btn-dark"> + Nuevo </a></div>
            </div>
    </div>
    <div class="card-body">
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
            <th class="text-sm">#</th>
            <th class="text-sm">Folio</th>
            <th class="text-sm">Orden Compra</th>
            <th class="text-sm">Fecha</th>
            <th class="text-sm">Responsable</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-sm"> <a href="{{ route($route['show'], $item->id) }}">{{ $item->number }}</a></td>
            <td class="text-sm">{{ $item->number_order }}</td>
