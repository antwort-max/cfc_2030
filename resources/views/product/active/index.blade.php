      ...
      <table id="example" class="table table-hover dt-responsive nowrap">
        <thead class="thead-dark">
          <tr>
            ...
            <th class="text-sm">Empaquetamiento</th>
            <th class="text-sm">Costo</th>
            <th class="text-sm">Activo ERP</th>
            <th class="text-sm">Activo WEB</th>
            <th class="text-sm">Activo API</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-sm"> <a href="{{ route($route['show'], $item->id) }}">{{ $item->product->name }}</a></td>
            <td class="text-sm">{{ $item->package->name }}</td> 
            <td class="text-sm">{{ $item->amount }}</td> 
            <td class="text-sm">{{ $item->active_erp }}</td> 
            <td class="text-sm">{{ $item->active_web }}</td> 
            <td class="text-sm">{{ $item->active_api }}</td> 
