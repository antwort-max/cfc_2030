...
use App\Models\Worker\Workers as DbData;
use App\Models\User;
...
class WorkersController extends Controller
    {
        public function __construct()
        {
            ...
            $this->controller_name = "Trabajadores";
            $this->controller_route = 'worker.worker';
        ...
        public function store(Request $request)
        {
            ...
            if ($request->hasFile('image'))
            {
                ...
                $data->image  = $request->file('image')->store('worker', 'public');
                $data->update();
            }
