...
use App\Models\Product\ProductUnit as DbData;
...
class ProductUnitController extends Controller
{
    public function __construct()
    {
        ...
        $this->controller_name = "Unidad";
        $this->controller_route = 'product.unit';
        ...
        $this->url = [
            'index' => 'product.unit.index',
            'form'  => 'product.unit.form',
            'data'  => 'product.unit.data',
        ];
    }
