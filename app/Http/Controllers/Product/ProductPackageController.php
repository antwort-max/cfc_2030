...
use App\Models\Product\ProductPackage as DbData;
...
class ProductpackageController extends Controller
{
    public function __construct()
    {
        ...
        $this->controller_name = "Empaque";
        $this->controller_route = 'product.package';
        ...
        $this->url = [
            'index' => 'product.package.index',
            'form'  => 'product.package.form',
    ...
    public function create()
    {
        ...
        return view($this->url['form'],compact('unit', 'url', 'title', 'status_form', 'breadcrumb', 'route'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            $data->image  = $request->file('image')->store('productFamily', 'public');
            $data->update();
        }
    ...
    public function show($id)
    {
        ...
        return view($this->url['form'], compact('unit', 'url', 'data', 'title', 'status_form', 'breadcrumb', 'route'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->url['form'], compact('unit', 'url', 'data', 'title', 'status_form', 'route', 'breadcrumb'));
    }
