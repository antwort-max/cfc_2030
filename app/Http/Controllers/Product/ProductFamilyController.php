...
use App\Models\Product\ProductFamily as DbData;
...
class ProductFamilyController extends Controller
{
    public function __construct()
    {
        ...
        $this->controller_name = "Familia";
        $this->controller_route = 'product.family';
        ...
        $this->url = [
            'index' => 'product.family.index',
            'form'  => 'product.family.form',
            'data'  => 'product.family.data',
        ];
    }
