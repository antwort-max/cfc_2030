...
use App\Models\Web\WebNotice as DbData;
...
class WebNoticeController extends Controller
{
    public function __construct()
    {
        ...
        $this->controller_name = "Noticias";
        $this->controller_route = 'web.web_notice';
        ...
        $this->url = [
            'index' => 'web.web_notice.index',
            'form'  => 'web.web_notice.form',
            'data'  => 'web.web_notice.data',
        ];
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            $data->image  = $request->file('image')->store('webNotice', 'public');
            $data->update();
        }
